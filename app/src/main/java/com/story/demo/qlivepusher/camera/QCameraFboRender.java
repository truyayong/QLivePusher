...
public class QCameraFboRender {
    private static final String TAG = "QCameraFboRender";
    ...
    public QCameraFboRender(Context context) {
        this.mContext = context;

        bitmap = ShaderUtil.createTextImage("江湖人称李大嘴", 50, "#ff0000", "#00000000", 0);
